export default {
  global: {
    ...
    descripcionCurso:
      'Apreciado aprendiz, es momento de iniciar el reccorido por el MOOC Emprendimiento Digital en el que conocerás la estructura de navegación en esta experiencia de formación.',
